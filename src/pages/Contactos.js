    ...
    return (
      ...
      <div className="hidden sm:block  w-full p-4 flex justify-between items-center pt-[18vh]">
        <div className="text-left space-y-4 col-10 pl-4">
         ...
         <p className="pl-2 text-[23px] text-xl font-regular text-customDark pt-20 flex items-center space-x-2 pb-2"><img width="24px" src='/email.png' alt="icon" /><span> - andremrmd@gmail.com</span></p>          
         <p className="pl-2 text-[23px] text-xl font-regular text-customDark flex items-center space-x-2">
            ...
            <span> - </span>          
            <a href="https://www.linkedin.com/in/o-andredoming/" target="_blank" rel="noopener noreferrer"><span>https://www.linkedin.com/in/o-andredoming/</span></a>
          </p>
          ...
          <p class="pl-2 text-[23px] text-xl font-regular text-customDark flex items-center space-x-2">
