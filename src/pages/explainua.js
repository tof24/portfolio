    ...
    return (
      ...
      <div className='block sm:hidden px-4'>
        <div className="text-xl  text-customDark ">
              <p className='font-demi text-[60px] ml-[-2px] pt-10 pb-4'>explain.ua</p>
              <p className='font-regular text-[24px]'>PHP | MySQL</p>
        </div>
        <div className="text-justify pt-10">
          <div className='text-[16px]'>
            <p className="font-regular font-futura pb-3">
            O projeto explain.ua é uma plataforma digital desenvolvida para facilitar o apoio acadêmico entre estudantes da Universidade de Aveiro, especialmente para os alunos de Novas Tecnologias da Comunicação. Utilizando metodologias de Design Thinking, o projeto passou por várias fases, desde a definição do conceito até a prototipagem e testes de usabilidade, visando criar um ambiente intuitivo para interação e esclarecimento de dúvidas entre estudantes. A plataforma permite que estudantes solicitem ajuda de mentores por meio de tickets de dúvida, consultem respostas anteriores e, caso necessário, se comuniquem via chat ou videochamadas. Este processo é suportado por um design acessível, garantindo uma experiência imersiva e orientada ao usuário.            </p>
          
          {showMore && (
            <p className="font-regular font-futura z-10">
            Durante o desenvolvimento do explain.ua, foram realizados testes de baixa e alta fidelidade, cujos resultados orientaram ajustes para aprimorar a navegação e a compreensão dos usuários. O protótipo de alta fidelidade foi implementado com um design responsivo e uma paleta de cores suave, escolhida para reduzir o estresse visual, contribuindo para um ambiente acolhedor. Adicionalmente, melhorias foram implementadas para tornar o sistema mais acessível, como a revisão de cores para daltonismo e opções de layout adaptáveis. Com uma interface simples e amigável, o explain.ua foi idealizado para promover o aprendizado colaborativo e apoiar a saúde mental dos estudantes.            </p>
          )}
        ...
        <div className="mt-6  pb-10">
          ...
          <video src="./explainua.mp4" autoPlay controls loop muted className="w-full h-auto"></video>
        </div>
      ...
      <div className="hidden sm:grid grid-cols-1 md:grid-cols-2 gap-4 p-4 md:pt-[20vh]">
        ...
        <div className="px-5 md:pl-10 md:mr-[20px] lg:mr-[100px]  text-justify">
          <div className='z-10 text-[16px] pb-[8vh]'>
          ...
          <div className="z-10 text-xl  pb-10 text-customDark ">
            <p className='font-demi text-[15vh] leading-[140px]'>explain.ua</p>
            <p className='font-regular text-[30px]'>PHP | MySQL</p>
          </div>
        </div>
        ...
        <video 
            ...
            loop 
            muted 
            controlsList="nodownload noaudio" 
