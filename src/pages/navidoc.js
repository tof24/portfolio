    ...
    <div className="display h-screen sm:flex sm:flex-col sm:pl-3 z-50">
      ...
      <div className='block sm:hidden px-4'>
        <div className="text-xl  text-customDark ">
              <p className='font-demi text-[60px] ml-[-2px] pt-10 pb-4'>navidoc</p>
              <p className='font-regular text-[24px]'>React.js | Node.js | Puppeteer</p>
        </div>
        <div className="text-justify pt-10">
          <div className='text-[16px]'>
            <p className="font-regular font-futura pb-3">
            O projeto NAVIDOC é uma plataforma digital criada para proporcionar aos utilizadores uma experiência de criação e personalização de documentos interativos, explorando tecnologias como web scraping e APIs de armazenamento local. O site permite que os utilizadores iniciem novos documentos ou editem documentos existentes, utilizando um sistema que recolhe automaticamente conteúdos a partir de URLs inseridas. Este conteúdo, que inclui textos, imagens e links, é posteriormente apresentado de forma estruturada e personalizável, permitindo ao utilizador organizar e adaptar o layout de acordo com as suas preferências.
            </p>
          
          {showMore && (
            <p className="font-regular font-futura z-10">
              Desenvolvido através de um processo iterativo, o NAVIDOC foi ajustado ao longo de várias fases para otimizar a usabilidade e maximizar a flexibilidade na criação de conteúdos personalizados. A interface final possui um design minimalista e moderno, com cores suaves e elementos interativos que proporcionam uma navegação fluida e agradável. Os utilizadores, mesmo sem conhecimentos técnicos avançados, podem moldar a sua experiência de navegação e criar artefactos digitais únicos, refletindo as suas preferências e interesses pessoais.
            </p>
          )}
        ...
        <div className="mt-6  pb-10">
          ...
          <video src="./navidoc.mp4" autoPlay controls loop muted className="w-full h-auto"></video>
        </div>
        
      </div>

      {/* Tablet and Desktop */}
      <div className="hidden sm:grid grid-cols-1 md:grid-cols-2 gap-4 p-4 md:pt-[25vh]">
        {/* Text Section */}
        <div className="px-5 md:pl-10 md:mr-[20px] lg:mr-[100px]  text-justify">
          ...
          <div className="z-10 text-xl  pb-10 text-customDark ">
            <p className='font-demi text-[15vh] leading-[120px]'>navidoc</p>
            <p className='font-regular text-[30px]'>React.js | Node.js | Puppeteer</p>
          </div>
        </div>
